...
//    }
    ...
    // Commenting this out as we have a separate class for this which stores the client details
    // in database rather than in memory

//    @Bean
//    public RegisteredClientRepository registeredClientRepository() {
//        RegisteredClient oidcClient = RegisteredClient.withId(UUID.randomUUID().toString())
//                .clientId("oidc-client")
//                .clientSecret("$2a$12$O44XZMM5PxqGiUjSGUhryeaAPfS57rCNTXbvVC1bYVs.1E7CG/j2i")
